        ...
        <>
            <div className="w-full h-[91vh] bg-gray-950">
                <div className="flex flex-col items-center justify-center h-full">
                    <h1 className="text-3xl md:text-5xl lg:text-6xl px-4 md:px-2 lg:px-0 tracking-wide -mt-10 font-serif my-5 font-bold text-indigo-800">Task Management Application</h1>
                    <div className="flex items-center justify-between w-full px-[20vw]">
                        <div>
