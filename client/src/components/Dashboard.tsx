    ...
    return (
        <>
            <div className="w-full h-[91vh] bg-gray-950 px-10 py-5">
                {/* welcome txt */}
                <div>
                    <h1 className="text-3xl md:text-5xl lg:text-6xl tracking-wide font-serif my-5 font-bold text-indigo-800">Dashboard</h1>
                </div>
                {/* end */}
                ...
                <div className="flex flex-wrap lg:flex-nowrap items-center justify-between">
                    ...
                    {/* show content */}
                    <div className="w-[45%] h-[60vh] mx-5 text-white border-2 rounded-lg border-indigo-900">
                        ...
                        <div className="w-full h-[87%] text-sm px-4 overflow-scroll no-scrollbar">
                            {
                                alltask.map((task, index) => {
                                    return (
                                        <div key={index} className="border-2 border-indigo-900 text-gray-300 rounded-lg p-4 my-3">
