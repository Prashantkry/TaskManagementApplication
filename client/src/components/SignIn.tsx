...
import { setEmailData, setSignedIn } from "../redux/UserData";
...
export default function SignInPage() {
    ...
    return (
        <>
            <ToastContainer />
            <div className="bg-gray-950 h-[91vh]">
                <div className="xl:px-20 md:px-10 sm:px-6 px-4 md:py-12 py-9 2xl:mx-auto 2xl:container md:flex items-center justify-center signIn">
                    {/* login form start */}
                    <div className="bg-gray-900 shadow-lg rounded mt-10 xl:w-1/3 lg:w-5/12 md:w-1/2 w-full lg:px-10 sm:px-6 sm:py-10 px-5 py-6">
                        <p
                            tabIndex={0}
                        ...
                        >
                            ...
                            <button
                                className="hover:text-gray-500 border-0 focus:text-gray-500 focus:outline-none focus:underline hover:underline text-xs font-medium leading-none text-gray-500 cursor-pointer"
